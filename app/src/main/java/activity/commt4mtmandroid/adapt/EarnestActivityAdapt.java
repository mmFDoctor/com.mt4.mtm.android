...
public class EarnestActivityAdapt extends BaseAdapter {

    private List<Integer> data;
    private Activity activity;

    public EarnestActivityAdapt(List<Integer> data, Activity activity) {
        this.data = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.name.setText(data.get(position)+" USD");
        holder.rela.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.putExtra(UserFiled.dingjin,data.get(position));
